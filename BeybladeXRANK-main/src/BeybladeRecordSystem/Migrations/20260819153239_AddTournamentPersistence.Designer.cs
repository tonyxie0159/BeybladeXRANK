...
namespace BeybladeRecordSystem.Migrations
{
    ...
    [Migration("20260819153239_AddTournamentPersistence")]
    partial class AddTournamentPersistence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeybladeRecordSystem.Domain.Entities.TournamentMatch", b =>
                {
                    b.HasOne("BeybladeRecordSystem.Domain.Entities.Battle", "Battle")
                        .WithOne()
                        .HasForeignKey("BeybladeRecordSystem.Domain.Entities.TournamentMatch", "BattleId")
                        .OnDelete(DeleteBehavior.Restrict);
