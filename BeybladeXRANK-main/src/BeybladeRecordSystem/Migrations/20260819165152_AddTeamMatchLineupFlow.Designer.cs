...
namespace BeybladeRecordSystem.Migrations
{
    ...
    [Migration("20260819165152_AddTeamMatchLineupFlow")]
    partial class AddTeamMatchLineupFlow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeybladeRecordSystem.Domain.Entities.BattleLineupSelection", b =>
                {
                    ...
                    b.HasIndex("BattleId", "BeybladeId")
                        .IsUnique();

                    b.HasIndex("BattleId", "UserId", "PositionNo")
                        .IsUnique();
            ...
            modelBuilder.Entity("BeybladeRecordSystem.Domain.Entities.BattleTeamOrderSelection", b =>
                {
                    ...
                    b.HasIndex("BattleId", "TournamentEntryId", "PositionNo")
                        .IsUnique();

                    b.HasIndex("BattleId", "TournamentEntryId", "UserId")
                        .IsUnique();
